		...
		<!-- Main -->
			<section id="main" >
				...
				<header class="major special">
					...
					<section>
							<form method="post" action="updatePro.jsp" name="form" id="form" >
								<div class="row uniform 50%">
									...
									<div class="6u 12u$(xsmall)">
										<b>변경할비밀번호</b>
										<input type="password" name="changePassword" placeholder="Password change" />
									</div><br><br><br>
									<div class="6u 12u$(xsmall)">
										<b>이름</b>
										<input type="text" name="name" value="<%=dto.getName()%>" placeholder="name" />
									</div><br><br><br>	
									...
									<div class="6u$ 12u$(xsmall)">
										<input type="text"  name="address2" value="<%=dto.getAddress2()%>" placeholder="나머지 주소" />
									</div>
									<div class="6u$ 12u$(xsmall)">
										<b>전화번호</b>
										<input type="text" name="phone" value="<%=dto.getPhone()%>" placeholder="010-1111-2222" />
									</div>
									<div class="6u$ 12u$(xsmall)">
										<b>이메일</b>
										<input type="email" name="email" value="<%=dto.getEmail()%>" placeholder="qwe@naver.com" />
									</div>
