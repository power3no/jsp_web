...
ArrayList<CommentDTO> list = cdao.commentSelect(1, num);
%>
		<!-- Header -->
						...
						<table class="alt">
							...
							<tfoot>
								<tr>
									...
									<input type="button" onclick="location.href='board.jsp'" value="목록">
									<%
									if(session.getAttribute("id")!=null){
									if(session.getAttribute("id").equals(dto.getId())){
									%>
									<input type="submit" value="수정">
									<input type="button" onclick="location.href='delete.jsp?num=<%=num %>&value=1'" value="삭제"><%										
									}}
									%>
									</td>
								</tr>
