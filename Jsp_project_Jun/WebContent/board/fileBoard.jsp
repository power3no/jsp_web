...
ArrayList<BoardDTO> list = dao.boardSelect(3);
...
<!-- 							페이지 수에 맞는 게시물 출력 -->
								...
								<tr>
									...
									<a href = "fileContent.jsp?num=<%=dto.getNum()%>" ><%=dto.getSubject()%></a>
									</td>
									<td><%=dto.getId()%></td>
							...
							<tfoot>
								<tr>
									...
									<input type="button" value="글쓰기" onclick="location.href='fileWrite.jsp'"
									>
									<%}%>
