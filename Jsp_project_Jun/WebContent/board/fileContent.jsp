...
ArrayList<CommentDTO> list = cdao.commentSelect(3, num);
%>
		<!-- Header -->
						...
						<table class="alt">
							<tbody>
								...
								<tr>
									<td><b>첨부파일</b></td>
									<td colspan="3">
									<a href="fileDown.jsp?file_name=<%=dto.getFile()%>"><%=dto.getFile()%></a></td>
								</tr>
								<tr>
									<td><b>내용</b></td>
							...
							<tfoot>
								<tr>
									...
									<input type="button" onclick="location.href='fileBoard.jsp'" value="목록">
									<%
									if(session.getAttribute("id")!=null){
									if(session.getAttribute("id").equals(dto.getId())){
									%>
									<input type="submit" value="수정">
									<input type="button" onclick="location.href='delete.jsp?num=<%=num%>&value=3'" value="삭제"><%										
									}}
									%>
									</td>
								</tr>
